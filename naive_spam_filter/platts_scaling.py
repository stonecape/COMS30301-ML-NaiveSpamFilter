...
###
gnb = GaussianNB()													# default param values
gnb.fit( p_train.reshape( -1, 1 ), y_train )						# LR needs X to be 2-dimensional
p_calibrated = gnb.predict_proba( p_test.reshape( -1, 1 ))[:,1]
